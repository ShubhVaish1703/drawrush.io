  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-3 border-b border-white/20 bg-slate-900/50 shrink-0">
        <div
          className={`flex flex-wrap gap-y-3 items-center ${canDraw ? "justify-between" : "justify-center"}`}
        >
          {/* Tool Buttons */}
          {canDraw && (
            <div className="flex gap-2 items-start">
              <button
                ...
                disabled={!canDraw}
                className={`px-1.5 py-1 md:px-3 md:py-2 text-sm tracking-wide rounded-lg font-semibold transition $${!canDraw ? "opacity-50 cursor-not-allowed" : "cursor-pointer"} ${
                  tool === TOOLS.PEN
